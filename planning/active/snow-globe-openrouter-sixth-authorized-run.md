...
- Current truth and the focused contract are updated. Commit and deliver documentation/evidence bindings through this `codex/` branch and required check, then return `master` clean and synchronized. No further provider action is authorized.
