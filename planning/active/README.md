...
- **Active recovery plan:** [Snow Globe Frontend Product Recovery Plan](v3-snow-globe-frontend-recovery-plan.md) — F0 resident-founder foundation accepted; the first F1 frames were rejected as too realistic, tactile clay-and-wood miniature is now selected as the dominant language, and the [three-treatment replacement package](v3-snow-globe-f1-visual-target-package.md) awaits user review before the Golden Three/Golden Fifteen path.
...
The engineering evidence remains valid, but it does not establish a satisfying playable experience. F0 now defines the player fantasy, authority, citizen compact, first shared consequence, and first-fifteen-minute shape. F1 now has a user-selected macro language and three replacement style frames plus a presentation-only Godot study; none is accepted yet. Golden Three gameplay production remains blocked until that human gate passes. Offline/recorded cognition Interface work is part of the playable path; live local/premium execution remains a separately authorized gate. The reset does not authorize broad governance, markets, multiplayer, or unbounded content production. See [the product thesis](../PRODUCT-THESIS.md), [CURRENT_BUILD.md](../../CURRENT_BUILD.md), and the [recovery plan](v3-snow-globe-frontend-recovery-plan.md).
