...
- **Active recovery plan:** [Snow Globe Frontend Product Recovery Plan](v3-snow-globe-frontend-recovery-plan.md) — F0 resident-founder foundation accepted; the [F1 three-direction Candidate package](v3-snow-globe-f1-visual-target-package.md) awaits user selection, followed by a replacement Golden Three/Golden Fifteen path with cognition integrated through one provider-neutral Interface.
