...
W2-06 hard safety gates are green at `478a4d9`, and W3-01 through W3-05 are merged; delivery truth remains in Git/GitHub. Keep W3-06+ and broader Weeks 3-4 inactive. Candidate `5c732b1` carries the local `4`/`5` civic input and F3 interest inspection path; its uncommitted repair adds `6` for one visible offline cognition fallback and guards duplicates from restored `civic.cognition.decision` history after schema-v9 save/load. Final repair evidence and human author smoke remain incomplete.
