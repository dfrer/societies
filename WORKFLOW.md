...
- Implementation commit `8820734ecc8afd1a592c9077a9e441c5c4467d5d` is pushed in [stacked PR #179](https://github.com/dfrer/societies/pull/179), whose base is the open recovery-plan branch/PR #178 at `75b23e9de20be4797a233cb78ff8e8e1b3cd4daf`. CI is pending at this handoff-record update; neither PR is merged into `master`.
