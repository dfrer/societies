...
Exactly one current next action for this lane: add an offline Adapter conformance harness for the exact 12-slot/no-retry/binding/cancellation/buffer-ownership contract, without adding Ollama/premium implementation or live authority.
