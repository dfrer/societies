...
The next action is deliberately conservative and offline: add an Adapter conformance harness exercising a candidate registry-controlled adapter's exact 12-slot, no-retry, binding, cancellation, and buffer-ownership contract. It must not add Ollama/premium implementation or live authority.
