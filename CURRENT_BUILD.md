...
# Reproduce W1-05b diagnostic spike attribution from the clean W1-05 matrix artifacts.
...
- The required manifest declares 119 .NET tests: 89 fast, 11 integration, and 19 soak, plus 16 Godot headless tests.
...
- Schema v4 records cold, natural-warm, and forced-invalidation cache transitions plus the non-persistent selector mode and selector-specific bounds, exact-query accounting, pruning, route reuse, and phase timing. Natural warmup advances deterministic simulation state; eager/all-pairs cache prefill remains disabled.
