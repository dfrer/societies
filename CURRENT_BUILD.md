...
The current build is Prototype V3 W2-01: a deterministic local settlement simulation with terrain-aware logistics, a frozen crisis-contract boundary, and an isolated voxel feasibility spike.
...
- crisis contribution commands, settlement directives, terminal crisis events/HUD, and runtime snapshot schema v7
...
- The required manifest declares 211 .NET tests: 118 fast, 11 integration, and 82 soak, plus 16 Godot headless tests.
