...
# Reproduce current residual spike attribution from the clean W1-05c matrix artifacts.
...
- The required manifest declares 151 .NET tests: 89 fast, 11 integration, and 51 soak, plus 16 Godot headless tests.
